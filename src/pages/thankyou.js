    ...
    <section className="relative flex flex-col flex-grow justify-center pt-20 px-0">
      <div className="container md:w-1/2 flex flex-col items-center gap-8">
        ...
        <p className="ft-4 text-center">
          Muy pronto, uno de nuestros asesores se pondrá en contacto contigo para darte más info sobre como comenzar o vivas mejor de tus rentas.
        </p>
        <p className="text-center ft-2">
          Si no se abrió nuestro calendario para agendar tu evaluación gratuita
        </p>
